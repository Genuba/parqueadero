...
<body class="cbp-spmenu-push">
    ...
    <div id="page-wrapper">
			<div class="main-page">
                ...
                $adm_obj = new Administrador;

                foreach ($adm_obj->verAdministradores() as $row) {?>
						  	<tr>
                  <th scope="row"><?php print $row[0]; ?></th>
						  		...
						  		<td>
                    <a href=<?php echo "editarAdministrador.php?id=".$row[0]; ?> class="btn btn-info btn-lg"><span class="glyphicon glyphicon-pencil"></span> Editar</a>
                  </td>
						  	</tr>
                <?php } ?>
						  </tbody>
