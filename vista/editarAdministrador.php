...
<body class="cbp-spmenu-push">
    ...
    <div id="page-wrapper">
            ...
            <li class="active">Editar administrador</li>
              ...
              $documento = $_GET["id"];
              $adm_row = $adm_user->buscarAdministrador($documento)->fetch();

              ?>
              <form action=<?php echo "editarAdministrador2.php?id=".$documento; ?> method="post">
               <div class="form-group">
                 <label for="text">Nombres:</label>
                 <input type="text" class="form-control" id="text" name="nombres" required value=<?php echo $adm_row[1]; ?>>
               </div>
               <div class="form-group">
                 <label for="text">Apellidos:</label>
                 <input type="text" class="form-control" id="text" name="apellidos" required value=<?php echo $adm_row[2]; ?>>
               </div>
               <div class="form-group">
                 <label for="text">Correo:</label>
                 <input type="text" class="form-control" id="text" name="correo" required value=<?php echo $adm_row[3]; ?>>
               </div>
               <div class="form-group">
                 <label for="text">Celular:</label>
                 <input type="text" class="form-control" id="text" name="celular" required value=<?php echo $adm_row[4]; ?>>
               </div>
               <div class="form-group">
                 <label for="text">Usuario:</label>
                 <input type="text" class="form-control" id="text" name="usuario" value=<?php echo $adm_row[5]; ?>>
               </div>
               <div class="form-group">
                 <label for="text">Password:</label>
                 <input type="password" class="form-control" id="text" name="pwd" >
               </div>
