			...
			<div class="main-page">
              ...
              <form action="" method="post">
               <div class="form-group">
                 ...
                 <input type="text" class="form-control" id="text" name="adm_documento" required>
               </div>
               <div class="form-group">
                 <label for="text">Nombres:</label>
                 <input type="text" class="form-control" id="text" name="adm_nombres" required>
               </div>
               <div class="form-group">
                 <label for="text">Apellidos:</label>
                 <input type="text" class="form-control" id="text" name="adm_apellidos" required>
               </div>
               <div class="form-group">
                 <label for="text">Correo:</label>
                 <input type="email" class="form-control" id="text" name="adm_correo" required>
               </div>
               <div class="form-group">
                 <label for="text">Celular:</label>
                 <input type="text" class="form-control" id="text" name="adm_celular" required>
               </div>
               <div class="form-group">
                 <label for="text">Usuario:</label>
                 <input type="text" class="form-control" id="text" name="adm_usuario" required>
               </div>
               <div class="form-group">
                 <label for="pwd">Password:</label>
                 <input type="password" class="form-control" id="pwd" placeholder="Enter password" name="adm_password" required>
               </div>
             ...
             <?php
              ...
              $documento = $_POST["adm_documento"];
              $nombres = $_POST["adm_nombres"];
              $apellidos = $_POST["adm_apellidos"];
              $correo = $_POST["adm_correo"];
              $celular = $_POST["adm_celular"];
              ...
              if($documento != null){
              $adm_user->crearAdministrador($documento,$nombres,$apellidos,$correo,$celular,$usuario,$password);
              }
              ?>
						</div>
					</div>
