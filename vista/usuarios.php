...
<body class="cbp-spmenu-push">
    ...
    <div id="page-wrapper">
			<div class="main-page">
                ...
                foreach ($usu_user->verUsuarios('usuario') as $row) {?>
						  	<tr>
                  <th scope="row"><?php print $row[0]; ?></th>
						  		...
						  		<td>
                    <a href=<?php echo "editarUsuario.php?id=".$row[0]; ?> class="btn btn-info btn-lg"><span class="glyphicon glyphicon-pencil"></span> Editar</a>
                  </td>
						  	</tr>
                <?php } ?>
						  </tbody>
