...
<body class="cbp-spmenu-push">
					...
					<ul>
						<li class="dropdown profile_details_drop">
							...
							<ul class="dropdown-menu drp-mnu">
								...
								<li> <a href="index.html"><i class="fa fa-sign-out"></i> index</a> </li>
							</ul>
						</li>
					</ul>
				</div>
    ...
    <div id="page-wrapper">
            ...
            <li class="active">Editar Estudiante</li>
              ...
              $usu_row = $usu_user->buscarUsuario($documento)->fetch();

              ?>
              <form action=<?php echo "editarUsuario2.php?id=".$documento; ?> method="post">
               <div class="form-group">
                 <label for="text">Nombres:</label>
                 <input type="text" class="form-control" id="text" name="usu_nombres" required value=<?php echo $usu_row[1]; ?>>
               </div>
               <div class="form-group">
                 <label for="text">Apellidos:</label>
                 <input type="text" class="form-control" id="text" name="usu_apellidos" required value=<?php echo $usu_row[2]; ?>>
               </div>
               <div class="form-group">
                 <label for="text">Correo:</label>
                 <input type="text" class="form-control" id="text" name="usu_correo" required value=<?php echo $usu_row[3]; ?>>
               </div>
               <div class="form-group">
                 <label for="text">Placa Bicicleta:</label>
                 <input type="text" class="form-control" id="text" name="usu_placabici" value=<?php echo $usu_row[5]; ?>>
               </div>
               <div class="form-group">
                 <label for="text">UID:</label>
                 <input type="text" class="form-control" id="text" name="usu_UID" value=<?php echo $usu_row[5]; ?>>
               </div>
