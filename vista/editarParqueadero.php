			...
			<div class="main-page">
				<div class="forms">
					<h2 class="title1"><ol class="breadcrumb">
					  ...
					  <li><a href="parqueaderoes.php">parqueaderos</a></li>
            <li class="active">Editar parqueadero</li>
					</ol></h2>
					<div class="row">
              ...
              //error_reporting(0);
              require_once('../controlador/parqueadero.php');

              $par_obj = new Parqueadero;

              $par_id = $_GET["id"];
              $par_row = $par_obj->buscarParqueadero($par_id)->fetch();

              ?>
              <form action=<?php echo "editarParqueadero2.php?id=".$par_id; ?> method="post">
               <div class="form-group">
                 <label for="selector1" class="col-sm-2 control-label">Sede</label>
                 <div class="col-sm-8"><select name="fk_ced_id" id="fk_ced_id" class="form-control1">
                   <option value=<?php echo $par_row[0]; ?> selected><?php echo $par_row[1]; ?></option>
                   <?php
                   require_once('../controlador/sede.php');
                   $sede = new sede;
                   foreach ($sede->verSedes() as $row) {?>
